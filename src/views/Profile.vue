        ...
        <div class="profile-card">
          ...
          >
            ...
            <el-form-item label="注册时间">
              <el-input :value="formatTime(profileForm.registerTime)" disabled />
            </el-form-item>

            <el-form-item>
              <el-button type="primary" class="save-btn" :loading="loading" @click="handleSave">
                保存修改
              </el-button>
            </el-form-item>
          </el-form>
...
onMounted(async () => {
  ...
  if (userStore.userInfo) {
    ...
    profileForm.registerTime = userStore.userInfo.registerTime
  }
})
...
const handleSave = async () => {
  if (!profileFormRef.value || !userStore.memberId) return

  await profileFormRef.value.validate(async (valid) => {
    if (valid) {
      loading.value = true
      try {
        await updateMember(userStore.memberId!, {
